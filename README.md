...
国内
```
git clone https://ghproxy.com/https://github.com/yanyun0/nvjdcdocker2.4.git /root/nolanjdc
```
国外
```
git clone https://github.com/yanyun0/nvjdcdocker2.4.git /root/nolanjdc
```
